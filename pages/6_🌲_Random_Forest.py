# -*- coding: utf-8 -*-
"""
🌲 Random Forest Model Web Application
"""
    ...
    if uploaded_file is not None:
        try:
            ...
            if missing_columns:
                ...
                batch_probabilities = pipeline.predict_proba(model_input)[
                    :, 1
                ]
                ...
                result_data["pass_probability"] = (
                    batch_probabilities.round(4)
                )
                ...
                st.download_button(
                    ...
                    data=result_data.to_csv(index=False).encode(
                        "utf-8-sig"
                    ),
